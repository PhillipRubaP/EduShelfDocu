...
\begin{center}
	...
	\begin{table}[h!]
		\begin{tabular}{|p{50mm}|p{110mm}|}
			...
			\makecell*[{{p{110mm}}}]{\small{The result is a fully functional 'EduShelf' platform featuring user authentication, document upload and indexing, and an interactive AI chat. 
