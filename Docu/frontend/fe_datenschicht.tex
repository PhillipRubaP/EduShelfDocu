...
Zusätzlich stellt der Service spezifische Methoden bereit, die die Logik abbilden, beispielsweise \texttt{createChatSession}, \texttt{updateQuiz} oder \texttt{uploadDocument}. Letzteres nutzt \texttt{FormData}, um Datei-Uploads (multipart/form-data) zu ermöglichen.
