...
Beim Ändern eines Antworttextes darf der State nicht direkt angepasst werden. Stattdessen muss eine Kopie der betroffenen Ebenen erstellt werden -- das Prinzip der Immutability in React:
