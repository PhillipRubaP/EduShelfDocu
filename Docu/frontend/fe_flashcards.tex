...
Anstatt für jede Karte einen Boolean im Datenobjekt zu speichern, wird ein \texttt{Set} verwendet, das die IDs der umgedrehten Karten hält. Diese Trennung von UI-Zustand und Geschäftsdaten ist ein wichtiges Designprinzip:
...
const flipCard = (id) => {
    setFlippedCards(prevFlippedCards => {
        ...
        if (newFlippedCards.has(id)) {
            newFlippedCards.delete(id); // Karte zurueckdrehen
        } else {
