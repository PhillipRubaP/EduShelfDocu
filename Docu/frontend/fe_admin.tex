...
Das Panel ermöglicht CRUD-Operationen für Benutzer. Besonders hervorzuheben ist die verschachtelte Datenansicht: Klickt ein Admin auf einen Benutzer, werden dessen Dateien asynchron nachgeladen -- ein klassisches \textit{Master-Detail}-Szenario:

\begin{lstlisting}[language=JavaScript, caption={Lazy Loading von Detaildaten beim Nutzerklick}]
