...
Beim Starten der Komponente werden alle Benutzereinstellungen aus dem \texttt{localStorage} geladen und als initialer State gesetzt. Dieses Vorgehen stellt sicher, dass die Einstellungen über Seitenreloads und Browsersitzungen hinweg erhalten bleiben:
