...
Passwörter werden niemals im Klartext gespeichert. Stattdessen wird der \texttt{BCrypt}-Algorithmus \cite{provos1999bcrypt} verwendet, der durch seinen konfigurierbaren "Work Factor" (Kostenfaktor) resistent gegen Brute-Force- und Rainbow-Table-Angriffe ist.
