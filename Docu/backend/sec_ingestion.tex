...
\subsection{Textextraktion (OCR \& Parsing)}
...
\subsection{Embedding und Vektorspeicherung}
...
\begin{itemize}
    ...
    \item \textbf{HNSW Index:} In der PostgreSQL-Datenbank wird für die Spalte \texttt{Embedding} ein HNSW (Hierarchical Navigable Small World) Index \cite{malkov2018hnsw} angelegt.
    \begin{verbatim}
