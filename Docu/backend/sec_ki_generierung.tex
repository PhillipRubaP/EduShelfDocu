...
Die manuelle Fallback-Stufe erkennt dabei sowohl Antwortoptions als einfache Strings (\texttt{["Paris", "London", ...]}) als auch als Objekte (\texttt{[\{"text": ..., "isCorrect": ...\}]}). Dies macht die Quiz-Generierung robust gegen\"uber variierenden LLM-Antwortformaten.
