...
\begin{figure}[h]
    ...
    \label{fig:erd}
\end{figure}
(Hinweis: Das detaillierte Mermaid-Diagramm liegt als \texttt{database\_diagram.mermaid} bei und sollte für die finale Version als Bild exportiert werden.)
...
\begin{itemize}
    ...
    \item \texttt{UsersController}: Verwaltet Benutzerdaten sowie die Authentifizierung (Login, Registrierung).
\end{itemize}
