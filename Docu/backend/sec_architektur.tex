...
Hier residiert das "Gehirn"  der Anwendung. Alle Regeln und Prozesse sind in dieser Schicht implementiert.
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Entity Framework Core (EF Core):} Als Object-Relational Mapper (ORM) ermöglicht EF Core die Definition des Datenmodells in C\#-Klassen. SQL-Queries werden zur Laufzeit generiert, was die Entwicklung beschleunigt und vor SQL-Injection schützt.
