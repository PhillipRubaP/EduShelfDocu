...
\begin{itemize}
    ...
    \item \textbf{Dependency Injection:} Alle Services werden über den in .NET integrierten Dependency Injection (DI) Container registriert, was die Austauschbarkeit von Implementierungen zur Laufzeit ermöglicht.
...
\begin{itemize}
    \item \textbf{Entity Framework Core (EF Core):} Als Object-Relational Mapper (ORM) \cite{efcore} ermöglicht EF Core die Definition des Datenmodells in C\#-Klassen (siehe Abbildung~\ref{fig:erd}). SQL-Queries werden zur Laufzeit generiert, was die Entwicklung beschleunigt und vor SQL-Injection schützt.
